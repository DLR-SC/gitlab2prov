...
class GithubFetcher:
    ...
    def __post_init__(self, private_token, project_url) -> None:
        self.client = Github(login_or_token=private_token, per_page=100)
        self.repository = self.client.get_repo(full_name_or_id=project_slug(project_url))
