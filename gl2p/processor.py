...
from gl2p.objects import (Commit, PROVNode, PROVActivity, Addition,
                          Deletion, Modification, Resource,
                          CommitResourceCreation, Event)
...
class CommitResourceProcessor:
    """
    Prepare commits and commit notes to add to prov document by precomputing labels and id's.
    """
    project_id: str
    ...
    def events(self, c: Dict[str, Any], notes: List[Dict[str, Any]],
               eprev: PROVActivity, r: PROVNode,  rv_1: PROVNode) -> List[Event]:
        """
